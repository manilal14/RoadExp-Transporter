package com.road.roadexp_transporter.HomePage;
...
import com.road.roadexp_transporter.AddNewDriver.AddDriverPage;
...
import com.road.roadexp_transporter.FCM.SharedPrefFcm;
import com.road.roadexp_transporter.Initializer;
import com.road.roadexp_transporter.LoginSingUp.LoginPage;
import com.road.roadexp_transporter.LoginSingUp.LoginSessionManager;
import com.road.roadexp_transporter.NetworkState.ConnectivityReceiver;
import com.road.roadexp_transporter.MissedNotification.MissedNotificationPage;
import com.road.roadexp_transporter.Reports.MissedLoad.MissedLoadsPage;
import com.road.roadexp_transporter.Reports.PaymentReport.PaymentReportPage;
import com.road.roadexp_transporter.Reports.TravelReport.TravelReportHomePage;
import com.road.roadexp_transporter.VehiclePackage.UnverifiedVehicle.UnverifiedVehiclePage;
import com.road.roadexp_transporter.VehiclePackage.VehicleStatusHomePage;
import com.road.roadexp_transporter.R;
import com.road.roadexp_transporter.Review.ReviewBottomSheet;
import com.road.roadexp_transporter.NavigationDrawer.ExpandableListAdapter;
import com.road.roadexp_transporter.NavigationDrawer.MenuModel;
import com.road.roadexp_transporter.DriverPackage.DriverHomepage;
...
import static com.road.roadexp_transporter.CommonForAll.CommanVariablesAndFunctuions.BASE_TRANS_PROFILE_PIC;
...
import static com.road.roadexp_transporter.CommonForAll.CommanVariablesAndFunctuions.callIntent;
import static com.road.roadexp_transporter.CommonForAll.CommanVariablesAndFunctuions.getUnixInSec;
import static com.road.roadexp_transporter.LoginSingUp.LoginSessionManager.TRANS_NAME;
import static com.road.roadexp_transporter.LoginSingUp.LoginSessionManager.TRANS_PHONE;
...
public class AppHomePage extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    private void storeTokenToDb(final String refreshedToken) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_TOKEN, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Log.e(TAG,"fcm token response :" +response);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.call:
                callIntent(AppHomePage.this,"9554600400");
                break;
...
//        });
        ...
        String transPhone = mSession.getTransporterDetailsFromPref().get(TRANS_PHONE);

        String TRANS_PIC_URL = BASE_TRANS_PROFILE_PIC + transPhone+".jpg";

        Glide.with(AppHomePage.this).load(TRANS_PIC_URL)
