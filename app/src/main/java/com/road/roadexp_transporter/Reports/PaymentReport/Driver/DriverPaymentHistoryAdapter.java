package com.road.roadexp_transporter.Reports.PaymentReport.Driver;
...
public class DriverPaymentHistoryAdapter extends RecyclerView.Adapter<DriverPaymentHistoryAdapter.VehicleViewHolder> {

    private Context mCtx;
    private List<PaymentHistoryModel> mPaymentHistoryList;


    public DriverPaymentHistoryAdapter(Context mCtx, List<PaymentHistoryModel> travelHistoryList) {
        this.mCtx = mCtx;
    ...
    public VehicleViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new VehicleViewHolder(LayoutInflater.from(mCtx).inflate(R.layout.recycler_view_payment_report_driver,viewGroup,false));
    }
