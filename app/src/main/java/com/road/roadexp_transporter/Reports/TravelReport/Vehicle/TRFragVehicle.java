...
public class TRFragVehicle extends Fragment {
    ...
    private List<Vehicle> mVerifiedVehiclesList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mVerifiedVehiclesList = new ArrayList<>();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonResult.length();i++) {
                        ...
                        mVerifiedVehiclesList.add(new Vehicle(vehicleId, plateNumber,picRcFront,picRcBack,picVehicle,insuranceNum, addDate,
                                permitType,rcExpOn,vehicleType, dimension, capacity, mappedDriver, verifyFlag, did, tripId,status));
                    }

                    if(mVerifiedVehiclesList.size() == 0)
                    ...
                    TravelReportVehicleAdapter adapter = new TravelReportVehicleAdapter(getActivity(),mVerifiedVehiclesList);
