...
public class TRFragDriver extends Fragment {
    ...
    private List<Driver> mVerifiedDriverList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mVerifiedDriverList = new ArrayList<>();
        fetchVerifiedDriver();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonResult.length();i++) {
                        ...
                        mVerifiedDriverList.add(new Driver(driverId,name,mobile,sahar,state,ageInYear,joiningDate,noOfSuccessTrip,vType,
                                vNum,profPic,addharPic,dlFront,dlBack,t_av,d_av,status,1,vehicleId,bankAccd,tripId));
                    }

                    if(mVerifiedDriverList.size() == 0)
                    ...
                    TravelReportDriverAdapter adapter = new TravelReportDriverAdapter(getActivity(),mVerifiedDriverList);
