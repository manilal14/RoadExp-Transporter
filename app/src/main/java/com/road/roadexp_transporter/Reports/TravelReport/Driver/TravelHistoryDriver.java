package com.road.roadexp_transporter.Reports.TravelReport.Driver;
...
import com.road.roadexp_transporter.DriverPackage.Driver;
...
public class TravelHistoryDriver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDriver = (Driver) getIntent().getSerializableExtra("driverDetail");
        mProgressBar = findViewById(R.id.progress_bar);

        mTravelHistoryList = new ArrayList<>();
        fetchDriverTrivalHistory();
    ...
    private void fetchDriverTrivalHistory() {

        Log.e(TAG,"called : fetchMissedLoads");
        mProgressBar.setVisibility(View.VISIBLE);

        String URL = BASE_URL + "getHistoryTrip";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(code!=2){
                                Toast.makeText(TravelHistoryDriver.this,"code is not 2", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            ...
                            for(int i=0;i<result.length();i++){
                                ...
                                String driverName = mDriver.getName();
                            ...
                            TravelHistoryAdapter adapter = new TravelHistoryAdapter(TravelHistoryDriver.this,mTravelHistoryList);
                            recyclerView.setLayoutManager(new LinearLayoutManager(TravelHistoryDriver.this));
                            recyclerView.setAdapter(adapter);

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Log.e(TAG,e.toString());
                            Toast.makeText(TravelHistoryDriver.this, e.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(TravelHistoryDriver.this,error.toString(), Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
        ...
        MySingleton.getInstance(TravelHistoryDriver.this).addToRequestQueue(stringRequest);
