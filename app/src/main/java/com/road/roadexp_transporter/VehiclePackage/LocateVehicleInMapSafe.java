...
public class LocateVehicleInMapSafe extends FragmentActivity implements OnMapReadyCallback {
        ...
        try {
            boolean success = mMap.setMapStyle(
                    MapStyleOptions.loadRawResourceStyle(
                            LocateVehicleInMapSafe.this, R.raw.style_json));
            if (!success) {
    ...
    private void showOnMap(String location) {
        ...
        if(mCurrLocationMarker == null){
            ...
            markerOptions.icon(getMarkerIconFromDrawable(getDrawable(R.drawable.truck)));
    ...
    void changePositionSmoothly(LatLng newLatLng) {
        ...
        Drawable circleDrawable = ContextCompat.getDrawable(LocateVehicleInMapSafe.this,R.drawable.truck_to_animate);
    ...
    private void animateCar(final LatLng firstPoint, final LatLng secondPoint){
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(newPos, ZOOM_VALUE));
        mMap.animateCamera(CameraUpdateFactory
                .newCameraPosition(new CameraPosition.Builder().target(newPos).zoom(ZOOM_VALUE).build()));
