...
public class SingnUpNext extends AppCompatActivity {
    ...
    private boolean verifyCredential(String pass, String conPass, String account, String fleetSize) {

        if(pass.equals("") || conPass.equals("") || account.equals("") || fleetSize.equals("")){
    ...
    private void registerUser(final String pass, final String account, final String fleetSize, final String state, final String city) {
