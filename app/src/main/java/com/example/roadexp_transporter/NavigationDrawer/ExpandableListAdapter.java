package com.example.roadexp_transporter.NavigationDrawer;
...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        Typeface typefaceGBR = Typeface.createFromAsset(context.getAssets(),"font/lato_bold.ttf");
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        Typeface typefaceGMR = Typeface.createFromAsset(context.getAssets(),"font/lato_bold.ttf");
        ...
        if(menuModel.isHasChildren()) {
            lblListHeader.setCompoundDrawablesWithIntrinsicBounds(leftDrawalbleId,
                    0, isExpanded ? R.drawable.arrow_down : R.drawable.arrow_right2, 0);
        }
        else {
            lblListHeader.setCompoundDrawablesWithIntrinsicBounds(leftDrawalbleId,
                    0,0, 0);
